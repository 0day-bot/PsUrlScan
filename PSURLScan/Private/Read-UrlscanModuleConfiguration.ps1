function Read-UrlscanModuleConfiguration {
    <#
    .SYNOPSIS
    ...
    Try {
        ...
        Write-Log -Message "Unable to deserialize saved configuration from json. Please use Remove-UrlscanModuleConfiguration to remove the saved configuration."
    }
}